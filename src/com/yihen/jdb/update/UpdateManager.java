...
* @Package com.yihen.jdb.update 
* @Description: TODO
* @author frosty
* @date 2015-4-30 下午3:04:39 
* @version V1.0   
*/
package com.yihen.jdb.update;
...
import com.yihen.jdb.net.DHttpAgent;
	...
	public void checkAppUpdate(Context context, final boolean isShowMsg){
		...
		new Thread(){
			public void run() {
				...
				try {					
					Update update = DHttpAgent.checkVersion((AppContext)mContext.getApplicationContext());
					msg.what = 1;
					msg.obj = update;
