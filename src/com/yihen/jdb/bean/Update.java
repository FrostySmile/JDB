...
/**
 * @ClassName: Update
 * @Description: 更新实体，用于封装更新信息比对
 * @author Frosty
 * @date 2015-4-30 下午3:06:51
 *   
 */
public class Update extends Base implements Serializable{
			    ...
			    switch(evtType){ 
			    	case XmlPullParser.START_TAG:			    		
			            ...
			            else if(update != null)
			    		{
				            ...
				            {			      
			    					update.setVersionCode(StringTools.toInt(xmlParser.nextText(),0));
				            }
